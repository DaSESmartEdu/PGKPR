...
class LossCompute:
    ...
    def __init__(self, seq2seq_criterion, opt=None, vocab_size=8000):
    ...
    def __call__(self, sen, sen_label, norm, train=True):
        ...
        sen_label = sen_label.contiguous().view(-1)
        ...
        return s2s_loss.data * norm


class LabelSmoothing(nn.Module):
    def __init__(self, size, padding_idx, smoothing=0.0, cross_entro=False):
